...
<div class="container-fluid" id="about3">
    <div class="container">
            ...
            <div class="policycontent">
                    ...
                    <p>あなたがどのような人物かを判断するにはプロフィール欄を記入していただく必要があります。あなたの趣味や興味があるコトをより具体的に書くことで他者があなたをより理解できるようになります。
                    </p>
            </div>
            <div class="policycontent">
                <img src="uploads/logo/おこづかいアイコン2.png">
                <h2 class="rolename">オンライン決済</h2>
                <p>ユーザーがより安心してイベントに参加できるためイベント費用はすべてオンライン決済で取引を完結するサービスとなっております。イベントでの現金での取引などはトラブルの原因となる可能性もあるので禁止しております。</p>
            </div>
            <div class="policycontent">
