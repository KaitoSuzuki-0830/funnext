                ...
                @else
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            @if(Auth::check())
                                <img src="{{ isset($user)? secure_asset($user->profile->avatar): Auth::user()->profile->avatar}}"  height="40px" width="40px" style="border-radius: 50%" class="profile-image img-circle">
